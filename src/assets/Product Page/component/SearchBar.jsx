  ...
  return (
    <div className="flex gap-2 items-center justify-between w-full relative">
      ...
      <form
        ...
        className="flex items-center justify-between gap-1 border-2 border-darkGreen w-[90%] sm:grow sm:w-fit p-2 rounded-lg"
      >
        <button
          onClick={onSearch}
      ...
      {/* Filter Button */}
      <section className="flex justify-end w-[10%] sm:w-fit">
        <button
